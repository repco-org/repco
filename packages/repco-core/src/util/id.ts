...
export function createRepoId(timestamp?: Date | number): string {
...
export function createSourceRecordId(timestamp?: Date | number): string {
...
export class MultiID {
  ...
  static fromParts(
    ...
    const parts = [base32.baseEncode(part1), prefix, base32.baseEncode(part2)]
  ...
  toBytes(): Uint8Array {
    ...
    idbuf.write(parts[0])
    return Buffer.concat([parts[1], idbuf, parts[2]])
  }
}
