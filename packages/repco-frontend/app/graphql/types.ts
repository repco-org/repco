...
export type ConceptCondition = {
  ...
  containsName?: InputMaybe<Scalars['String']>;
...
export type LoadContentItemQuery = { contentItem?: { title: any, uid: string, content: any, revisionId: string, mediaAssets: { nodes: Array<{ uid: string, mediaType: string, title: any, duration?: number | null, files: { nodes: Array<{ contentUrl: string, mimeType?: string | null }> } }> } } | null };
...
export type LoadRepoStatsQuery = { contentItems?: { totalCount: number } | null, repos?: { nodes: Array<{ name?: string | null }> } | null };

export type LoadReposQueryVariables = Exact<{ [key: string]: never; }>;


export type LoadReposQuery = { repos?: { nodes: Array<{ did: string, name?: string | null }> } | null };
